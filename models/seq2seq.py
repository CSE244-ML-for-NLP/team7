...
class seq2seq(nn.Module):
    ...
    def forward(self, src1, src1_len, src2, src2_len, src3, src3_len, tgt, tgt_len,tgtv, tgtv_len,tgtpv, tgtpv_len):
        ...
        state = (torch.mean(torch.stack([b_state[0], user_state[0], sys_state[0]]), dim=0), torch.mean(torch.stack([b_state[1], user_state[1], sys_state[1]]), dim=0))
        ...
        # return loss,torch.tensor(soutputs),torch.tensor(voutputs),num,snums,vnums
